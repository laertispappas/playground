...
class SearchResult {
  ...
  constructor(obj?: any) {
    ...
    this.thumbnailUrl = obj && obj.thumbnail    || null;
...
export class SearchBox implements OnInit {
  ...
  ngOnInit(): void {
    ...
    .map((query: string) => this.youtube.search(query)) // search discard old events if new inputs comes in
    .switch()
...
><div class="row">
><search-result
>*ngFor="let result of results">[result]="result">
></search-result>
></div>
></div>
`
